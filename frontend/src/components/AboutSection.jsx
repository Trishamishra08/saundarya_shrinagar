...
const floatingImages = [
  { src: img1, size: 'w-24 h-32 md:w-32 md:h-44', top: '10%', left: '5%', delay: 0 },
  { src: img2, size: 'w-20 h-28 md:w-28 md:h-40', top: '20%', left: '20%', delay: 1 },
  { src: img3, size: 'w-28 h-36 md:w-40 md:h-52', top: '5%', left: '40%', delay: 0.5 },
  { src: img4, size: 'w-24 h-32 md:w-36 md:h-48', top: '15%', left: '60%', delay: 1.5 },
  { src: img5, size: 'w-20 h-28 md:w-32 md:h-44', top: '10%', left: '80%', delay: 0.2 },
  { src: img6, size: 'w-24 h-32 md:w-32 md:h-44', top: '40%', left: '10%', delay: 0.8 },
  { src: img7, size: 'w-28 h-36 md:w-40 md:h-52', top: '50%', left: '30%', delay: 1.2 },
  { src: img8, size: 'w-20 h-28 md:w-32 md:h-44', top: '45%', left: '70%', delay: 0.4 },
];
      ...
      <div className="relative w-full h-[400px] md:h-[600px] bg-brand-pink/20 overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-20 text-center px-4">
          <motion.h1 
            ...
            className="text-4xl md:text-6xl font-decorative text-brand-dark drop-shadow-sm"
          >
            Our Story
          </motion.h1>
        </div>
