          ...
          <SwiperSlide key={index}>
            <div className="relative h-full w-full overflow-hidden flex items-center bg-white">
              ...
              <img 
                src={slide.image} 
                alt={slide.title}
                className="absolute inset-0 w-full h-full object-cover transform scale-105 transition-transform duration-[10000ms] linear opacity-85"
              />
              
              {/* Refinement Overlay for Text Legibility */}
              <div className="absolute inset-0 bg-gradient-to-r from-white/70 via-white/30 to-transparent z-10" />
