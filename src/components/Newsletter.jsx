        ...
        <div className="max-w-2xl mx-auto italic">
          ...
          <form className="flex flex-col md:flex-row gap-4">
            <input 
              ...
              className="flex-1 px-6 py-4 rounded-full border-none focus:ring-2 focus:ring-brand-gold outline-none shadow-sm bg-white"
              required
            />
            <button 
              type="submit"
              className="bg-brand-dark text-white px-10 py-4 rounded-full font-bold hover:bg-brand-gold transition-colors shadow-lg"
            >
              Subscribe Now
            </button>
          </form>
